...
import 'package:mobx_weather/mobx_example/screens/review_widget.dart';
import 'package:mobx_weather/mobx_example/widgets/info_card.dart';
...
class _ReviewState extends State<Review> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(Constants.exampleTitle)),
      body: Center(
        child: Column(
